...
<script src="<?php echo e(asset('js/stuff/modal.js')); ?>" defer></script>
<script src="<?php echo e(asset('js/stuff/table.js')); ?>"></script>
<script src="<?php echo e(asset('/js/stuff/file-upload.js')); ?>"></script>

<?php /**PATH E:\MAMP\htdocs\cngtest6\resources\views/stuff/footer.blade.php ENDPATH**/ ?>