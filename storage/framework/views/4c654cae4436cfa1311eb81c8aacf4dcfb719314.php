                                ...
                                <div class="" id="select-stuff-to-add-trnsfer">
                                    ...
                                    <select name="stuff_id" id="stuff_id" class="inset form-control">
                                        ...
                                        <?php $__currentLoopData = $stuffs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $stuff): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option data-unit="<?php echo e($stuff->unit_name); ?>" data-code="<?php echo e($stuff->code); ?>"
                                                    value="<?php echo e($stuff->id); ?>"><?php echo e($stuff->name); ?></option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </select>
                                </div>
                            ...
                            <div class="form-group select-stuff-or-stuffpack">
                                <div class="" id="select-stuff-to-add-trnsfer">
                                    ...
                                    <select name="stuffpack_id" id="stuffpack_id" class="inset form-control">
                                        <option value="0" selected disabled>انتخاب کنید</option>
                                        <?php $__currentLoopData = $stuff_packes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $stuff_pack): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option data-code="<?php echo e($stuff_pack->code); ?>"
                                                    value="<?php echo e($stuff_pack->id); ?>"><?php echo e($stuff_pack->name); ?></option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </select>
                                </div>
...
<?php /**PATH E:\MAMP\htdocs\cngtest6\resources\views/stuff-transfer/transfer-stuff.blade.php ENDPATH**/ ?>