                            ...
                            <select name="stuff_id" id="stuff-select-input" class="inset form-control">
                                <?php if(App\Models\Stuff::all()->count()): ?>
                                    <?php $__currentLoopData = \App\Models\Stuff::all(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $stuff): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($stuff->id); ?>" data-stuff-code="<?php echo e($stuff->code); ?>" <?php $unit_name=\App\Models\Unit::select() ->where('id',
                                            $stuff->unit_id)
                                            ->first()->name; ?>
                                            data-stuff-unit="<?php echo e(json_encode($unit_name)); ?>"><?php echo e($stuff->name); ?>
                        ...
                        <div class="hidden" id="select-stuffpack-to-add">
                            ...
                            <select name="stuffpack_id" id="stuffpack-select-input" class="inset form-control">
                                <?php if(App\Models\Stuffpack::all()->count()): ?>
                                    <?php $__currentLoopData = \App\Models\Stuffpack::all(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $stuffpack): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($stuffpack->id); ?>"
                                            data-stuffpack-code="<?php echo e($stuffpack->code); ?>"><?php echo e($stuffpack->name); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                <?php endif; ?>
                            </select>
                        </div>
...
</div><?php /**PATH C:\wamp\www\cngtest_2\resources\views/temp-reciept/insert-new-temp-reciept.blade.php ENDPATH**/ ?>